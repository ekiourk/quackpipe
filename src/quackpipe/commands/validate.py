...
def register_command(subparsers: _SubParsersAction):
    ...
    parser_validate.add_argument("-e", "--env-file", nargs='+',
                                 help="Path(s) to .env file(s) to load for secret resolution.")
    parser_validate.add_argument("--resolve-secrets", action="store_true",
